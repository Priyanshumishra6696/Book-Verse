...
@Composable
fun ReligiousSectionScrollableRow(navController: NavController,viewModel: BooksViewModel){
    val booksearchResult by viewModel.getBooksForSection("Religious").observeAsState()
