...
@Composable
fun NonFictionSectionScrollableRow(navController: NavController,viewModel: BooksViewModel){
    val booksearchResult by viewModel.getBooksForSection("NonFiction").observeAsState()
