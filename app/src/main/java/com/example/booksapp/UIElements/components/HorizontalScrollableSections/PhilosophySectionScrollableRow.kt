...
@Composable
fun PhilosophySectionScrollableRow(navController: NavController,viewModel: BooksViewModel){
    val booksearchResult by viewModel.getBooksForSection("Philosophy").observeAsState()
