...
@Composable
fun ScienceSectionScrollableRow(navController: NavController,viewModel: BooksViewModel){
    val booksearchResult by viewModel.scienceBooksResult.observeAsState()
